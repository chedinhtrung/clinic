...
export default function Navbar(
    ...
    return (
        <nav className="p-2 items-center px-8 bg-navy-mid flex gap-4 text-white leading-relaxed sticky top-0 z-10">
            ...
            >
                ...
                <br />
                <span className="font-sans text-xs text-gold tracking-normal uppercase sm:text-sm text-xs">
            ...
            <div className="flex gap-2 justify-center items-center ml-auto  h-full font-bold uppercase hidden sm:block">
